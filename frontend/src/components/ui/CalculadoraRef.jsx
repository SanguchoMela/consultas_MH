        ...
        <>
            ...
            <div ref={printRef} className="print:p-8">
                ...
                <p className="font-medium my-4 px-3">
                    Interés generado: <span className="text-red-600">${estadoCuenta.totalInteres}</span>
                </p>
                <p className="border font-bold p-2 rounded-lg bg-cyan-700/10 text-center">
                    Saldo a pagar:{" "}
                    <span className="text-cyan-800">
                        ${estadoCuenta.totalConMora}
                    </span>
                </p>
                    ...
                    <table className="min-w-full table-auto shadow-md text-sm">
                        <thead className="sticky top-0 z-10">
                            <tr className="sub-label">
                                ...
                                <th className="table-fc-label">Interés</th>
                                <th className="table-fc-label">Total a pagar</th>
                                <th className="table-fc-label">Saldo</th>
                            </tr>
                        </thead>
